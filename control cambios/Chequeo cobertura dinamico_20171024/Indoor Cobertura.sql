use dashboard
exec dbo.sp_lcc_dropifexists '_temp_4G_Indoor'
exec dbo.sp_lcc_dropifexists '_temp_3G_Indoor'
exec dbo.sp_lcc_dropifexists '_temp_2G_Indoor'
...
SELECT v.entidad,
  ...
  into [dashboard].dbo._temp_4G_Indoor
  ...
  into [dashboard].dbo._temp_3G_Indoor
  ...
  into [dashboard].dbo._temp_2g_Indoor
  ...
  select v1.entidad + '- Indoor',
		 ...
		 from [dashboard].dbo._temp_4G_Indoor v1, [dashboard].dbo._temp_3g_Indoor v2, [dashboard].dbo._temp_2g_Indoor v3
